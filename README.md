...
**Stats:** 96 prompts · 13 categories, each targeting 500 distinct prompts · 2 languages (EN / UK). See [`docs/roadmap.md`](docs/roadmap.md) for live per-category progress. Coding & Development — 93/500.
...
- 12 new `coding` prompts (en/uk) — API contract consistency, bug repro narrowing, migration lock-risk auditing, unfamiliar-module explaining, mobile perf trace interpretation, IaC drift detection, threat-modeling kickoff, cross-language idiom mapping, feature-flag rollout planning, rate-limiting design, tech-debt prioritization, and concurrency bug hunting. See [`docs/coverage-matrix/coding.md`](docs/coverage-matrix/coding.md) for the full shipped list.
- [API Contract Consistency Reviewer](en/coding/api-contract-consistency-reviewer.md) ([UK](uk/coding/api-contract-consistency-reviewer.md)) — `coding`
- [Concurrency Bug Hunter](en/coding/concurrency-bug-hunter.md) ([UK](uk/coding/concurrency-bug-hunter.md)) — `coding`
- [Threat Modeling Kickoff](en/coding/threat-model-kickoff.md) ([UK](uk/coding/threat-model-kickoff.md)) — `coding`
...
**Статистика:** 96 промптів · 13 категорій, кожна з ціллю 500 унікальних промптів · 2 мови (EN / UK). Актуальний прогрес по категоріях — у [`docs/roadmap.md`](docs/roadmap.md). Кодинг та розробка — 93/500.
...
- 12 нових промптів `coding` (en/uk) — узгодженість API-контракту, звуження баг-репортів, аудит ризику блокувань при міграціях, пояснення незнайомих модулів, інтерпретація мобільних перф-трейсів, виявлення дрейфу IaC, старт моделювання загроз, зіставлення ідіом між мовами, планування рол-ауту через feature flag, дизайн rate limiting, пріоритизація техборгу та полювання на баги конкурентності. Повний список — у [`docs/coverage-matrix/coding.md`](docs/coverage-matrix/coding.md).
- [Перевірка узгодженості API-контракту](uk/coding/api-contract-consistency-reviewer.md) ([EN](en/coding/api-contract-consistency-reviewer.md)) — `coding`
- [Полювання на баги конкурентності](uk/coding/concurrency-bug-hunter.md) ([EN](en/coding/concurrency-bug-hunter.md)) — `coding`
- [Старт моделювання загроз](uk/coding/threat-model-kickoff.md) ([EN](en/coding/threat-model-kickoff.md)) — `coding`
